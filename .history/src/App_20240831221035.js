    ...
    <div className="App">
      ...
      <div className='page-content'>
        ...
        <section className='contact mt-2'>
          I’m currently available for Freelance Projects. Feel free to say hi to me anytime!
          Email: <a href= "mailto: name@email.com"> name@email.com </a>maxsun.prod@gmail.com
        </section>
      </div>
    </div>
  );
