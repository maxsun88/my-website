  ...
  return (
    <div className="App">
      ...
      <div className='page-content'>
        ...
        <section className='film-guideline mt-3'>
          <h2>What is a great film?</h2>
          <p>
            A movie down the core is storytelling; it should be both <b>entertaining</b> and <b>impactful</b>. <br/><br/>
        ...
        <section className='contact mt-3 pb-6'>
          <h2>Contact</h2>
          <p>
            I’m currently available for Freelance Projects. Feel free to say hi to me anytime!<br/>
