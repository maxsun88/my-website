  ...
  return (
    <div className="App">
      ...
      <div className='page-content'>
        ...
        <section className='film-guideline'>
          <h2>What is a great film?</h2>
          <p>
          A movie down the core is about storytelling; it should be both entertaining and impactful. Good films entertain us with a great plot, brings laughter and immerse us in other worlds. But what makes a film great is its ability to make us think, inspire us, and even bring about change. 
          </p>
