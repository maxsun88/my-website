    ...
    <div className="page-content film-journey">
      <div className="card">
        <div className="content py-2 px-3">
          ...
          <p className='section-link'><Link to="/journey/toronto">5. For Pete's Sake</Link></p>
          <p className='section-link'><Link to="/journey/toronto">6. Making a Musical in 48 Hours!,/</Link></p>
        </div>
      </div>
      <Outlet />
    </div>
