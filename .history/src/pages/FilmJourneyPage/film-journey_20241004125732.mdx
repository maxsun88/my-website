...
<div className="pt-4 pb-4">
  <ImageGallery items={latteArtImages} showThumbnails={false} showFullscreenButton={false} showFullscreenButton={false} showPlayButton={false}/>
</div>
...
<div className="pt-4 pb-4">
  <ImageGallery items={aFewMoreImages} showThumbnails={false} showFullscreenButton={false} showFullscreenButton={false} showPlayButton={false}/>
</div>
