...
<div className="pt-4 pb-4">
  <ImageGallery items={fpsImages} showThumbnails={false} showFullscreenButton={false} showFullscreenButton={false} showPlayButton={false}/>
</div>
...
<img className="journey-image" id="musical-draw-image" src="/images/journey/MusicalDraw.webp" alt="film journey image"></img>
