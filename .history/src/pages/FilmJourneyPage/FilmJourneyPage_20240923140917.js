...
export const FilmJourneyPage = () => {
  return (
    <div className='page-content film-journey'>
      ...
      <p>I have to thank my high school for my first short film.
        <br/><br/>

        I went to a pretty awesome high school in Beijing, and we had a short film festival every year (that is very rare). In high school, everybody wanted to be special. So was I. I thought I watched so many films, why not make one myself?        <br/>
        ...
        Later on, the film was sent to a film festival for high school students in Beijing and it won the Best Film.</p>
