...
export const FilmJourneyPage = () => {
  return (
    <div className='page-content'>
      ...
      As I grew up I always felt so deeply connected with films. Every time when I went to the cinema it has always been the best time - that's when I could escape to a different world. But it wasn't until high school when I realized this is something I want to do as a profession.</p>
