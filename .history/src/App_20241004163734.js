    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "section3", element: <FilmJourneyContent3 /> },
          { path: "section4", element: <FilmJourneyContent4 /> },
          { path: "section5", element: <FilmJourneyContent5 /> },
          { path: "section6", element: <FilmJourneyContent6 /> },
        ],
