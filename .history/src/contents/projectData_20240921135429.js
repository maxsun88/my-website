...
View the final film here: https://t.ly/6sXfY`
    ...
    'lolas-recipe':{
        title: "Lola's Recipe",
        role: "Producer",
        lengthAndYear: "3 min, 2022",
        videoLink: "https://youtu.be/3MF6fmGeJRg",
        intro: `A mother has to find the courage to tell her little daughter the passing of the grandma. What connects the family in the end is the beloved bakery recipe the grandma left. As the story is set in filipino culture, Lola means exactly "grandma" in Tagalog. 
