  ...
  return (
    <>
      <div className="video-wrapper">
        ...
        >
          <source
            src={`${process.env.PUBLIC_URL}/2024 Quick Reel For Website.mp4`}
            type="video/mp4"
          />
      ...
      <div className="page-content">
        <div className="py-10-md py-5">
          <p className="radley-regular header-text u-text-center">
            <i>Hello,</i> I'm Max
          </p>
        ...
        <section className="projects-section mt-8 row">
          ...
          <div className="projects-display ml-auto mt-8 mt-2-md col-md-8">
            <FilmProject
              ...
              tagline={
                "WWI Short Film, Shot on Arri Alexa Mini \n(Post Production)"
              }
            ...
            <FilmProject
              ...
              tagline={
                "48HFP Ottawa: Best Acting Ensemble & Best Supporting Peformance 🏆\n"
              }
            ...
            <FilmProject
              ...
              tagline={
                "Sci-fi 48 Hour Film Project Finalist 🏆\nBest Director Nomination 🏅"
              }
            ...
            <FilmProject
              ...
              tagline={
                "A Musical Made in 48 Hours! 48HFP Toronto 2023 - \nAudience Choice Award 🏆 \nFinalist - top 15 / 108 teams 🏆 "
              }
              role="Lead Producer"
            ...
            <FilmProject
              ...
              tagline={
                "Beijing Youth Film Festival (High School Category) - Best Film 🏆"
              }
              role="Director, Producer, Writer & Editor"
        ...
        <section className="commercial-projects mt-10">
          <h2>Commercial Projects</h2>
          <div className="mt-4 video-embed-wrapper">
            <ReactPlayer
              className="react-player"
              controls={true}
              width="100%"
              height="100%"
              url="https://vimeo.com/1071546912"
            />
          </div>
          <h3 className="mt-1">SuOn Academy Promotional Video</h3>
          <h4>Director, Writer & Editor - 90s Spot, 2025</h4>
        </section>
        <section className="film-guideline mt-10">
          <h2 className="mb-3">What is a great film to me?</h2>
          <p>
            A movie down the core is storytelling. A good story should be both{" "}
            <b>entertaining</b> and <b>impactful</b>. <br />
            <br />
            Good films entertain us with a great plot, brings laughter and
            immerse us in other worlds. But what makes a film great is its
            ability to make us think, inspire us, and even bring about change.
          </p>
        </section>
        <section className="contact mt-10 pb-6">
          <h2 className="mb-3">Contact</h2>
          <p>
            I’m currently available for freelance projects. Feel free to say hi
            to me anytime!
            <br />
            <br />
            Email:{" "}
            <a href="mailto: maxsun.prod@gmail.com"> maxsun.prod@gmail.com</a>
          </p>
        </section>
      </div>
    </>
